...
function toArrayBuffer(input: Uint8Array): BufferSource {
  // Re-wrap bytes into a fresh Uint8Array so WebCrypto receives a BufferSource
  // from the current runtime realm instead of a sliced cross-realm buffer.
