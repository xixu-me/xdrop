        ...
        <Card className="hero-card page-hero-card">
          ...
          <dl className="page-meta">
            ...
            <div className="page-meta-item">
              ...
              <dd className="page-meta-value">{new Date(transfer.expiresAt).toLocaleString()}</dd>
            </div>
            <div className="page-meta-item">
  ...
  return (
    <div className="share-layout">
      <Card className="hero-card page-hero-card">
        ...
        <div className="button-row">
          <Button onClick={() => void copyLink()} disabled={!transfer.shareUrl}>
            {copyState === 'copied' ? 'Copied' : 'Copy link'}
          </Button>
          <Button onClick={() => void shareLink()} tone="ghost" disabled={!transfer.shareUrl}>
            Share link
          </Button>
          <Link className="button button--ghost" to="/transfers">
            Manage transfers
